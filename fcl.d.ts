declare module '@onflow/fcl' {
  ...
  // TODO add
  export function limit(value: any): any;
  export function proposer(authz: any): Promise<(ix: any) => any>;
  export function payer(authz: any): Promise<(ix: any) => any>;
  export function ref(refBlock: any): Promise<any> | ((d: any) => Promise<any>);
  export function authorizations(ax: any): Promise<any> | ((d: any) => Promise<any>);
  ...
  export function tx(transactionId: string): {
     ...
     */
    subscribe(callback: (tx: TransactionObject) => void): () => Promise<any>;
    /**
